...
| Overall RAWR rate    | 28.1%           | RAWR / (RAWR + faithful) — % of correct answers using shortcut           |
| Overall flip rate    | 29.2%           | sycophantic_failure / total_misleading — % of hints causing wrong answer |

### Hypothesis Verdicts

| Hypothesis                   | Verdict      | Evidence                                                                                                      |
|:-----------------------------|:-------------|:--------------------------------------------------------------------------------------------------------------|
| H1: Shared shortcut subspace | ✅ Strong    | Min zero-shot AUC = 88.8% across all hint types                                                               |
| H3: Internal shortcut traces | ✅ Moderate  | RAWR shortcut rate consistently higher by 7.4% on average                                                     |
| H2: Causal patching          | ⚠️ Very weak | Max flip rate = 20.0% (sycophantic_failure: 0.0%, right_answer_wrong_reason: 20.0%, faithful_reasoning: 0.0%) |
